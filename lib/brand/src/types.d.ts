...
export type BrandValidator<ValueType> = ((value: unknown) => value is ValueType) | StandardSchemaV1<unknown, ValueType>;
 ...
 */
export type Nominal<ValueType = never, BrandName = never> = ValidateBrandValueType<ValueType, BrandConstructor<ValueType, BrandName> & BrandMethods<ValueType, BrandName> & TypeMarker<ValueType, BrandName>>;
/**
...
export type BrandConstructor<ValueType = never, BrandName = never> = (value: ValueType) => BrandValue<ValueType, BrandName>;
type ValidateBrandValueType<ValueType, IfNormalType> = ValueType extends [never] ? "Brand value type cannot be unset, please provide a value type" : IfNormalType;
export {};
