...
export function useListUserGroupsWithUsers(backend: Backend): ListUserGroupsWithUsersQueryResult {
  ...
  const errorUpdatedAt = Math.max(
    listUsersQuery.errorUpdatedAt,
    listUserGroupsQuery.errorUpdatedAt,
  );
...
export function useEnsureListDirectory(backend: Backend, category: Category) {
  ...
  return useEvent(async (parentId: DirectoryId) => {
...
function useDeleteAsset(backend: Backend, category: Category) {
  ...
  return useEvent(async (assetId: AssetId, parentId: DirectoryId) => {
...
export function useNewSecret(backend: Backend) {
  ...
  return useEvent(async (name: string, value: string, parentId: DirectoryId) => {
...
export function useNewDatalink(backend: Backend) {
  ...
  return useEvent(async (name: string, value: unknown, parentId: DirectoryId) => {
...
export function useRemoveSelfPermissionMutation(backend: Backend) {
  ...
  const mutate = useEvent((id: AssetId) => {
  ...
  const mutateAsync = useEvent(async (id: AssetId) => {
