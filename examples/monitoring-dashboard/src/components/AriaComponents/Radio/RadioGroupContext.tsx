...
export function RadioGroupProvider(props: React.PropsWithChildren) {
  ...
  const setRadioPressed = eventCallback.useEvent((value: string) => {
    setPressedRadio(value);
  });

  const clearPressedRadio = eventCallback.useEvent(() => {
...
export function useRadioGroupContext(props: UseRadioGroupContextProps) {
  ...
  const setPressed = eventCallback.useEvent(() => {
    context.setPressedRadio(value);
  });

  const clearPressed = eventCallback.useEvent(() => {
