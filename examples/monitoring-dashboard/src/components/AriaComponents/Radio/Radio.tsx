...
export interface RadioProps extends aria.RadioProps, RefProp<HTMLLabelElement> {
...
export const Radio = function Radio(props: RadioProps) {
  ...
  return (
    <label
      ...
      ref={(el) => {
        mergeRefs.mergeRefs(labelRef, forwardedRef)(el);
      }}
      className={base()}
    >
      <input
...
} as unknown as ((props: RadioProps) => React.JSX.Element) & {
