...
export default defineConfig(({ mode }) => ({
  ...
  resolve: {
    alias: {
      ...
      "@lib/rsc-service-worker-bff": path.resolve(libDir, "rsc-service-worker-bff"),
      "@lib/tracing": path.resolve(libDir, "tracing/index.ts"),
      "@lib/brand": path.resolve(libDir, "brand/brand.ts"),
      tracing: path.resolve(libDir, "tracing/index.ts"),
      "performance-monitor": path.resolve(libDir, "performance-monitor/index.ts"),
      "#": path.resolve(rootDir, "src/*"),
    },
  },
  build: {
