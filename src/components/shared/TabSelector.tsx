...
export function TabSelector({
  ...
  return (
    <div className="flex justify-center mb-8">
      <div className="inline-flex rounded-xl [corner-shape:squircle] border-2 border-gray-200 p-1">
        <button
          disabled={activeTab === "unset"}
          onClick={() => handleTabChange("custom")}
          className={`px-6 py-2 rounded-xl [corner-shape:squircle] text-sm font-medium transition-all duration-200 ${
            activeTab === "custom"
