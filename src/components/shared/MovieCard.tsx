...
export function MovieCard({
  ...
  return (
    <div className="[content-visibility:auto] [contain-intrinsic-size:160px] group bg-white border-[0.5px] border-gray-100 rounded-2xl [corner-shape:squircle] overflow-hidden hover:border-black hover:shadow-lg flex flex-col sm:flex-row max-w-3xl mx-auto w-full">
      {/* Movie Info */}
      <div className="p-3 sm:p-4 flex-1 flex flex-col gap-2">
        <div className="flex items-start justify-between gap-2">
          ...
          >
            <div className="animate-spin h-3 w-3 border-3 border-[0.5px] border-gray-300 border-t-black rounded-full" />
