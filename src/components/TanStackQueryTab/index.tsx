...
import { MovieCardTanStack } from "./MovieCardTanStack";
...
export function TanStackQueryTab() {
  ...
  const { data: movies, isFetching } = useSuspenseQuery({
    queryKey: ["tanstack-movies", searchQuery],
    queryFn: () => searchMovies(searchQuery, 500),
  });
